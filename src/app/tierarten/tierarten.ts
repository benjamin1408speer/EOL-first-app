...
export class Tierarten {
  ...
  onVoegelClick() {
    let route = this.fullUrl() + '/' + 'voegel'
    console.log('onVoegelClick:', route)
    this.router.navigate([route])
  }
  onSaugeClick() {
    let route = this.fullUrl() + '/' + 'sauge'
    console.log('onSaugeClick:', route)
    this.router.navigate([route])
  }
  onKrusteClick() {
    let route = this.fullUrl() + '/' + 'kruste'
    console.log('onKrusteClick:', route)
    this.router.navigate([route])
  }
